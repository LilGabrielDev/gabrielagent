...
'        <tr><td style="padding:24px;">\n' +
          text.split("\n").map(function(line) {
            return '<p style="margin:0 0 12px 0;font-size:15px;line-height:1.6;color:#334155;">' + escapeHtml(line) + '</p>';
          }).join("") + '\n' +
'        </td></tr>\n' +
'        <tr><td style="border-top:1px solid #E2E8F0;padding:16px 24px;text-align:center;">\n' +
'          <p style="margin:0;font-size:12px;color:#94A3B8;">' + escapeHtml(name) + ' &middot; Powered by Gabriel</p>\n' +
'        </td></tr>\n' +
'      </table>\n' +
'    </td></tr>\n' +
'  </table>\n' +
